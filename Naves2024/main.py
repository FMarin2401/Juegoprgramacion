...
import modulo_juego as mj  # Importa el módulo modulo_juego.py que contiene la clase Juego
...
# Construir el juego
este_juego = mj.Juego()  # Inicializa un objeto de la clase Juego del módulo modulo_juego
